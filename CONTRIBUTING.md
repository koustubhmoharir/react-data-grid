Use [Github issues](https://github.com/koustubhmoharir/react-data-grid/issues) for feature requests and bug reports.
...
[submitting an issue](#submit-issue) to our [GitHub Repository](https://github.com/koustubhmoharir/react-data-grid). Even better, you can
[submit a Pull Request](#submit-pr) with a fix.

## <a name="feature"></a> Want a Feature?
You can *request* a new feature by submitting an issue to our [GitHub
Repository](https://github.com/koustubhmoharir/react-data-grid). If you would like to *implement* a new feature, please submit an issue with
...
```sh
git clone https://github.com/koustubhmoharir/react-data-grid.git
cd react-data-grid
npm install
npm run dev-server
```
